...
public class Print_field_descending_passport_id extends AbstractCommand {
    ...
    public boolean execute(String [] arguments){
        try {
            var response =(PrintFieldDescendingPassportIdCommandResponse) client.sendAndReceiveCommand(new PrintFieldDescendingPassportIdCommandRequest(SessionHandler.getCurrentUser()));
