...
public static Map<Integer, Person> people =new HashMap<>();
    public Person(int id,String name, Coordinates coordinates, LocalDate creationDate, Integer height, LocalDate birthday,String passportID, Country nationality, Location location, int creatorId) {
        this.id = id;
        this.name = name;
...
this.nationality=nationality;
    ...
    public Person copy(int id) {
        return new Person(id, this.name, this.coordinates, this.creationDate,
                this.height, this.birthday, this.passportID, this.nationality, this.location, this.creatorId
        );
    }
