...
public class PersonAdder {
    Scanner sc;
    public UserIDNumber UIN = new UserIDNumber(0);
...
nationality_id =3;
    ...
    public Person build()throws IncorrectInputInScriptException, OutOfLimitsException, WrongDateFormatException, UnknownCountryException {
        return new Person(1, setName(sc),setCoordinates(sc),setCreationDate(),setHeight(sc),setBirthdayDate(sc),setPassportID(sc),setNationality(sc),setLocation(sc),UIN.getGlobalID() );
    }
}
