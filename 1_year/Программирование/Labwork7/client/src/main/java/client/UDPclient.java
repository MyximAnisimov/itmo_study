...
public static UserIDNumber UIN = new UserIDNumber(0);

    public static VisibilityArgument VA = new VisibilityArgument(Visibility.UNLOGGED_USER);
    ...
    public Response sendAndReceiveCommand(Request request) throws IOException {
        ...
        UIN.setGlobalUserId(response.user_id);
        UIN.setCountable(response.getCountable());
