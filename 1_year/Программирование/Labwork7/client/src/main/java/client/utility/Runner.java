    ...
    public void interactiveMode3() {
        ...
        try {
            ...
            do {
                ...
                commandStatus = launchCommand(userCommand);
                System.out.println("Вывод с третьей консоли!");
            } while (commandStatus != ExitCode.EXIT);
    ...
    public void interactiveMode2() {
        ...
        try {
            ...
            do {
                ...
                commandStatus = launchCommand(userCommand);
                System.out.println("Вывод со второй консоли!");
...
case "login"-> {
    if(!commands.get("login").execute(userCommand)){
        System.out.println("Переход на новое окно!");
