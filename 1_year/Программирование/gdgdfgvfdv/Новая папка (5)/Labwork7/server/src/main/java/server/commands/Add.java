    ...
    public Add( CollectionManager collMan){
        ...
        public Response execute(Request request) {
            ...
            try {
                ...
                var person_id = dBhandler.addElement(req.person, UDPserver.user_id.getGlobalID(req.user_id));
                if(person_id>-1){
                    req.person.setID(person_id);
                    req.person.setCreatorId(UDPserver.user_id.getGlobalID(req.user_id));
                }
