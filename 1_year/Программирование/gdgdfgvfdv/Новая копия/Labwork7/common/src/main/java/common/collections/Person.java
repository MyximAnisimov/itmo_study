...
public static Map<Integer, Person> people =new HashMap<>();
    public Person(int id,String name, Coordinates coordinates, LocalDate creationDate, Integer height, Date birthday,String passportID, int nationality_id, Location location, int creatorId) {
        this.id = id;
        this.name = name;
