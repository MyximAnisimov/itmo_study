...
<table class="table1">
    ...
    <form action="" method="POST" id="html_form">
        <td class="column1" colspan="3">
            ...
            <input type="checkbox" value=-5 id="coordX-5" class="coordX" name="coordX" required>
            <label for=coordX-5>-5</label>
            <input type="checkbox" value=-4 id="coordX-4" class="coordX" name="coordX" required>
            <label for=coordX-4>-4</label>
            <input type="checkbox" value=-3 id="coordX-3" class="coordX" name="coordX" required>
            <label for=coordX-3>-3</label>
            <input type="checkbox" value=-2 id="coordX-2" class="coordX" name="coordX" required>
            <label for=coordX-2>-2</label>
            <input type="checkbox" value=-1 id="coordX-1" class="coordX" name="coordX" required>
            <label for=coordX-1>-1</label>
            <input type="checkbox" value=0 id="coordX0" class="coordX" name="coordX" required>
            <label for=coordX0>0</label>
            <input type="checkbox" value=1 id="coordX1" class="coordX" name="coordX" required>
            <label for=coordX1>1</label>
            <input type="checkbox" value=2 id="coordX2" class="coordX" name="coordX" required>
            <label for=coordX2>2</label>
            <input type="checkbox" value=3 id="coordX3" class="coordX" name="coordX" required>
